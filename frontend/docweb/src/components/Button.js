...
function buttonStyle(color) {
    switch(color) {
        ...
        case "pink outline big": 
            return "bg-transparent hover:bg-zinc-200 active:bg-zinc-300 border border-[3px] border-pink-400 py-[12px] px-8 rounded-md text-pink-400 text-xl font-semibold transition duration-150 ease-in-out";
            case "green outline": 
