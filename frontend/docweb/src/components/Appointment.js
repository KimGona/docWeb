    ...
    return (
        ...
        >
            ...
            <div className="absolute leading-none inline-block text-white h-[27px] w-[136px] left-[50.78%] right-[28.11%] top-[8%] bottom-[74%]">
                ...
                <p className="text-xl font-bold inline m-0 leading-[normal]">{"9:00"}</p>
            </div>
            ...
            <p className="right-0 absolute text-sm font-light text-black inline m-0 h-[27px] w-[123px] left-[80.9%] top-[76.67%] bottom-[5.33%] leading-[normal]">
                {"edit appointment"}
            </p>
            ...
            <div className="w-5 absolute left-[93.79%] right-[3.11%] top-[8%] bottom-[78.67%] [background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/a1547176849379cd5d6ffbf2c49c6896753941a0.webp)_center_/_cover]" />
        </div>
    );
}
